...
## Project Structure
    ...
    ├── lingering_sunset_de_96342  # Django project configurations
...
1. Clone this repo and `cd lingering_sunset_de_96342`
...
2. Clone this repo and `cd lingering_sunset_de_96342`
